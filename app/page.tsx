      ...
      <HomeAnimations>
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-4 py-24 text-center md:px-6 md:py-32 lg:px-8">
            <div className="hero-badge mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card/80 px-4 py-1.5 text-sm font-medium text-muted-foreground shadow-sm backdrop-blur-xl">
        ...
        <section className="reveal-section relative z-10 mx-auto max-w-5xl px-4 md:px-6 lg:px-8">
          <div className="grid gap-4 sm:grid-cols-3">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="reveal-card glass-strong rounded-2xl p-6 text-center"
              >
          ...
          <div className="mx-auto max-w-6xl px-4 py-20 md:px-6 md:py-28 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {steps.map((item) => (
                <div
                  key={item.step}
                  className="reveal-card glass-surface relative rounded-2xl p-6"
                >
